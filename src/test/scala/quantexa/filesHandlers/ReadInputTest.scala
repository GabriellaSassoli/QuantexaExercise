...
class ReadInputTest extends FlatSpec with Matchers {
  ...
  it should "Throw an error in case empty lines added" in {
    ...
    caught.getMessage shouldBe "Failed to process file wrongText.txt at line 1 because of Index 1"
  }
  ...
  it should "Throw an error in case number of lines of a column is incorrect" in {
    ...
    caught.getMessage shouldBe "Failed to process file wrongNumbersOfColumns.txt at line 1 because of Index 4"
  }
